...
function smarty_block_t($params, $text, &$smarty)
{
	...
	//puts the locale value in the globals var so that it can be read by any template
	if(!empty($locale) && $locale) {
		
		$par = array('put' => 'language', 'value' => $locale);
		
		//when the template is read and set into a variable for some unknow reasons the function smarty_function_global is out of scope
		if(function_exists('smarty_function_global')) {
			smarty_function_global($par, $smarty);
		} else {
			static $globals;
